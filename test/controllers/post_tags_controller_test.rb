...
class PostTagsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create post_tag" do
    assert_difference('PostTag.count') do
      post post_tags_url, params: { post_tag: { post_id: @post_tag.post_id, title: @post_tag.title } }
    end
  ...
  test "should update post_tag" do
    patch post_tag_url(@post_tag), params: { post_tag: { post_id: @post_tag.post_id, title: @post_tag.title } }
